...
class WorkTaskFactory extends Factory
{
    ...
    {
        $workCompletedAt = fake()->optional(0.5)->dateTimeBetween('-3 months', 'now');
        ...
        return [
            ...
            'work_started_at' => $workCompletedAt
                ? fake()->dateTimeBetween('-3 months', $workCompletedAt)
                : fake()->optional(0.5)->dateTimeBetween('-3 months', 'now'),
        ];
    }
}
